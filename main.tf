...
locals {
  ...
  karpenter_node_iam_role_arn    = try(module.karpenter_resources[0].iam_role_arn, var.karpenter_node.iam_role_arn, "")
  ...
  output_karpenter_node_instance_profile_name = try(module.karpenter_resources[0].instance_profile_arn, var.karpenter_node.instance_profile_name, "")
  ...
  karpenter_set = [
    ...
    },
    {
      ...
      value = local.karpenter_enable_spot_termination ? module.karpenter_resources.queue_name : null
    },
    {
...
module "karpenter_resources" {
  ...
  node_iam_role_additional_policies = try(var.karpenter.node_iam_role_additional_policies, {})
...
resource "aws_eks_pod_identity_association" "example" {
  ...
  role_arn        = module.karpenter_resources.iam_role_arn
}
...
module "karpenter" {
  ...
  #source_policy_documents = try(var.karpenter.iam_policy_document, [])
